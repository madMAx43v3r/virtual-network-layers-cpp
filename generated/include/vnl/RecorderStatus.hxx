...
#ifndef INCLUDE_VNI_GENERATED_vnl_RecorderStatus_HXX_
#define INCLUDE_VNI_GENERATED_vnl_RecorderStatus_HXX_
...
class RecorderStatus : public vnl::Value {
public:
	static const uint32_t VNI_HASH = 0xc8a62879;
	...
	static RecorderStatus* create();
	static RecorderStatus* create(vnl::Hash32 hash);
	virtual RecorderStatus* clone() const;
	...
	virtual const char* get_type_name() const { return "vnl.RecorderStatus"; }
	
	virtual int get_type_size() const { return sizeof(RecorderStatus); }
...
#endif // INCLUDE_VNI_GENERATED_vnl_RecorderStatus_HXX_
