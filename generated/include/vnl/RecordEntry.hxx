...
#ifndef INCLUDE_VNI_GENERATED_vnl_RecordEntry_HXX_
#define INCLUDE_VNI_GENERATED_vnl_RecordEntry_HXX_
...
class RecordEntry : public vnl::Value {
public:
	static const uint32_t VNI_HASH = 0x6d2a8c15;
	...
	static RecordEntry* create();
	static RecordEntry* create(vnl::Hash32 hash);
	virtual RecordEntry* clone() const;
	...
	virtual const char* get_type_name() const { return "vnl.RecordEntry"; }
	
	virtual int get_type_size() const { return sizeof(RecordEntry); }
...
#endif // INCLUDE_VNI_GENERATED_vnl_RecordEntry_HXX_
