...
#ifndef INCLUDE_VNI_GENERATED_vnl_OutOfMemoryException_HXX_
#define INCLUDE_VNI_GENERATED_vnl_OutOfMemoryException_HXX_
...
class OutOfMemoryException : public vnl::Exception {
public:
	static const uint32_t VNI_HASH = 0x61b281b0;
	...
	static OutOfMemoryException* create(vnl::Hash32 hash);
	virtual OutOfMemoryException* clone() const;
	...
	virtual const char* get_type_name() const { return "vnl.OutOfMemoryException"; }
	
	virtual int get_type_size() const { return sizeof(OutOfMemoryException); }
...
#endif // INCLUDE_VNI_GENERATED_vnl_OutOfMemoryException_HXX_
