...
#ifndef INCLUDE_VNI_GENERATED_vnl_InvalidValueException_HXX_
#define INCLUDE_VNI_GENERATED_vnl_InvalidValueException_HXX_
...
class InvalidValueException : public vnl::Exception {
public:
	static const uint32_t VNI_HASH = 0x455aebea;
	...
	static InvalidValueException* create();
	static InvalidValueException* create(vnl::Hash32 hash);
	virtual InvalidValueException* clone() const;
	...
	virtual const char* get_type_name() const { return "vnl.InvalidValueException"; }
	
	virtual int get_type_size() const { return sizeof(InvalidValueException); }
...
#endif // INCLUDE_VNI_GENERATED_vnl_InvalidValueException_HXX_
