...
#ifndef INCLUDE_VNI_GENERATED_vnl_RecordConfig_HXX_
#define INCLUDE_VNI_GENERATED_vnl_RecordConfig_HXX_
...
class RecordConfig : public vnl::Value {
public:
	static const uint32_t VNI_HASH = 0x2abbb9fe;
	...
	static RecordConfig* create();
	static RecordConfig* create(vnl::Hash32 hash);
	virtual RecordConfig* clone() const;
	...
	virtual const char* get_type_name() const { return "vnl.RecordConfig"; }
	
	virtual int get_type_size() const { return sizeof(RecordConfig); }
...
#endif // INCLUDE_VNI_GENERATED_vnl_RecordConfig_HXX_
